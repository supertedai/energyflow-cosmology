...
% No unicode. Everything ASCII. Clean LaTeX.
...
\]
where $a_{\text{edge}}$ determines endpoint curvature.
...
Regions with $S \approx s_0$ focus light;  
regions with $S \approx s_1$ defocus light.
