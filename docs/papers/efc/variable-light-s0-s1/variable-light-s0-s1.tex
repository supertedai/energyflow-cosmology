...
A Formal Treatment of the s\textsubscript{0} / s\textsubscript{1} Structure in Energy-Flow Cosmology (EFC)}}
...
a maximum at an intermediate optimal value $S_\*$ where the grid balances
flexibility and stability.

A minimal symmetric model is:
\begin{equation}
    c_{\mathrm{eff}}(S) = 
    c_0 \exp\!\left[-\alpha (S - S_\*)^2 \right],
\end{equation}
...
flexibility ($S_\*$) and then to dissipative ($s_1$).}
\end{figure}
