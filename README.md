Perfekt — her er den oppdaterte `README.md`-versjonen i ren Markdown, inkludert:

* badge-seksjon øverst
* den korrekte mappestrukturen som du ba om
* auto-update-felt nederst (du kan enten la det stå som plassholder eller aktivere workflowen senere)
...
Vil du at jeg lager den lille GitHub Action-filen (`update-readme-date.yml`) slik at `Last updated:`-feltet automatisk fylles inn ved hver commit?
