...
\title{EFC --- Entropy-Dependent Speed of Light Through the $s_0$/$s_1$ Phase Thresholds}
...
\caption{Illustration of the $s_0$/$s_1$ phase boundary and its effect on the emergent speed of light.}
\end{figure}
